...
public class AdminController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Model.getInstance().getViewFactory().getAdminMenuOptions().addListener(((observableValue, oldVal, newVal) -> {
            switch (newVal){

                case FIND -> user_parent.setCenter((Model.getInstance().getViewFactory().getFindView_admin()));
