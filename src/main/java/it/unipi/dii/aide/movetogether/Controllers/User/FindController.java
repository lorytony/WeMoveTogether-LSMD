...
import it.unipi.dii.aide.movetogether.Views.*;
...
public class FindController implements Initializable {
    ...
    public ListView activities_listview;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        searchType_box.setItems(FXCollections.observableArrayList(FindType.ACTIVITY,FindType.USER,FindType.PATH));
    ...
    public void changeFindDescription(){
        ...
        if(searchType_box.getValue() == FindType.USER){
        ...
        }else if(searchType_box.getValue() == FindType.ACTIVITY){
            minDistance_fld.setVisible(true);
            maxDistance_fld.setVisible(true);
            minDuration_fld.setVisible(true);
            maxDuration_fld.setVisible(true);
            endDate_picker.setVisible(true);
            startDate_picker.setVisible(true);
            name_lbl.setText("Name Activity:");
            location_lbl.setText("Location: ");
        }
    ...
    public void onFind(){
        ...
        if(searchType_box.getValue() == FindType.USER){
            ...
            String nameAct = name_fld.getText();
            ...
            Model.getInstance().findActivities(nameAct,minDist,maxDist,minDur,maxDur,loc);
            activities_listview.getItems().clear();
            activities_listview.refresh();
            activities_listview.setItems(Model.getInstance().getFoundActivities());
            activities_listview.setCellFactory(e -> new ActivityCellFactory());
            activities_listview.refresh();
        }else if(searchType_box.getValue() == FindType.PATH){
            ...
            paths_listview.setCellFactory(e -> new PathCellFactory());
            paths_listview.refresh();
