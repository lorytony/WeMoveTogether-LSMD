...
public class PathCellController implements Initializable {
    ...
    public PathCellController(Path path){
        this.path = path;
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        location_lbl.textProperty().bind(new SimpleStringProperty((path.locationProperty().getValue())));
