...
public class MoverProfileController implements Initializable {
    ...
    public void initData(){
        ...
        try {
            profileImage = new Image("https://randomuser.me/api/portraits/women/1.jpg",77, 77, false, false);

        }catch (NullPointerException | IllegalArgumentException e){
            profileImage = new Image("file:src/main/resources/Images/profilePhotoNotLoaded.jpg",77, 77, false, false);
        }


        userPhoto_imageView.setImage(profileImage);
        userPhoto_imageView.setFitHeight(77);
        userPhoto_imageView.setFitWidth(77);
